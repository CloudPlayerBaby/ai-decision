...
public class ReportGenerationNode implements NodeAction<DecisionState> {
    ...
    public Map<String, Object> apply(DecisionState state) throws Exception {
        eventPublisher.publishEvent(new NodeExecutionEvent(this, "ReportGeneration", state.getDecisionId(), "STARTED"));
        ...
        eventPublisher.publishEvent(new NodeExecutionEvent(this, "ReportGeneration", state.getDecisionId(), "FINISHED"));
